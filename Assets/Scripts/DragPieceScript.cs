...
public class DragPieceScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(sceneCamera.GetComponent<Camera>().ScreenToWorldPoint(Input.mousePosition), Vector2.zero);
